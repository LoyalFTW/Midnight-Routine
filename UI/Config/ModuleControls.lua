...
local function CreateGrip(parent, height, enabled, onStart, onCommit)
    ...
    label:SetFont(FONT_HEADERS, 13, GetFontFlags())
...
local function CreateExpandButton(parent, expanded, onToggle)
    ...
    label:SetFont(FONT_HEADERS, 10, GetFontFlags())
...
local function CreateHideCompleteButton(parent, moduleKey, anchor)
    ...
    local label = button:CreateFontString(nil, "OVERLAY")
    label:SetFont(FONT_ROWS, 8, GetFontFlags())
    label:SetPoint("CENTER")
...
function Config.CreateModuleControl(spec)
    ...
    label:SetFont(FONT_ROWS, spec.fontSize, GetFontFlags())
...
function Config.CreateTaskControl(spec)
    ...
    label:SetPoint("RIGHT", frame, "RIGHT", -32, 0)
    label:SetJustifyH("LEFT")
    label:SetText(spec.label)
    ...
    visibilityLabel:SetFont(FONT_ROWS, spec.fontSize, GetFontFlags())
